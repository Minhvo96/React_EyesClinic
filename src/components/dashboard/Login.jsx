              ...
              >
                <div className="card mb-0 row" style={{ flexDirection: "row" }}>
                  <div className="card-body col-4">
                    <div className="text-nowrap logo-img text-center d-block py-3 w-100 mb-3">
                      <img src="logo2.png" width={280} alt="" />
                    </div>
                  ...
                  <div
                    className="card-body col-8"
                    style={{
                      backgroundImage: 'url("frontend/images/BSMinh3.jpg")',
