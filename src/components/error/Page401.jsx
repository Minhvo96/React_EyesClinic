              ...
              <div className='container-fluid' style={{ paddingTop: "0px", paddingBottom: "0px" }}>
                <div className="card mb-0 d-flex align-items-center justify-content-center p-4" style={{ flexDirection: 'column' }}>                 
                      <img
                        ...
                        alt=""
                      />                                       
                      <h1 className='error-title text-danger text-center' style={{fontSize:"3rem"}}>Chưa xác thực!</h1>
                      <p className="text-center fw-bold" style={{fontSize:"1.25rem"}}>Bạn phải đăng nhập để truy cập trang này</p>
                      <Link to='/login'>
                        <button
                            type='submit'
